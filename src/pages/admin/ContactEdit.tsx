...
function ContactEditForm() {
  ...
  useEffect(() => {
    if (contact) {
      setFormData({
        titre: contact.titre || { fr: "", ar: "", en: "" },
        email: contact.email || "",
        telephone_1: contact.telephone_1 || "",
        telephone_2: contact.telephone_2 || "",
        telephone_fixe: contact.telephone_fixe || "",
        adresse: contact.adresse || { fr: "", ar: "", en: "" },
        ville: contact.ville || { fr: "", ar: "", en: "" },
        wilaya: contact.wilaya || { fr: "", ar: "", en: "" },
        ...
        x: contact.x || "",
        message_acceuil: contact.message_acceuil || { fr: "", ar: "", en: "" },
      });
    }
  }, [contact]);
  ...
  return (
    <div className="min-h-screen bg-muted/30">
          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Modify your organization's contact details
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              >
                ...
                {isUpdating ? "Saving..." : "Update Contact"}
              </Button>
            </div>
          </div>
        </div>
      ...
      <div className="container mx-auto px-6 py-8">
        <form id="contact-edit-form" onSubmit={handleSubmit}>
